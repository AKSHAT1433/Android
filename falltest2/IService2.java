...
public class IService2 extends Service implements SensorEventListener {
    ...
    //SMS Variables 8503391620
    SmsManager smsManager = SmsManager.getDefault();
    String phoneNum = "9617838277";
    String textMsg;
...
//                                textMsg = "Sensed Danger here => "+"http://maps.google.com/?q=<"+latitude+">,<"+longitude+">";
                            ...
                            if (phoneNum != prevNumber && phoneNum != null) {
                                ...
                                textMsg = "Sensed Danger here => " + "https://www.google.com/maps/search/?api=1&query=" + String.valueOf(latitude) + "," + String.valueOf(longitude);
